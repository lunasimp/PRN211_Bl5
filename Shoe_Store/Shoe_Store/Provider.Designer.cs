namespace Shoe_Store
{
	partial class Provider
	{
		...
		private void InitializeComponent()
		{
			...
			// btnUpdate
			// 
			btnUpdate.Location = new Point(700, 56);
			...
			// txtQuantity
			// 
			txtQuantity.Location = new Point(119, 57);
			...
			// 
			Price.AutoSize = true;
			Price.Location = new Point(40, 61);
			Price.Name = "Price";
			...
			// txtProviderName
			// 
			txtProviderName.Location = new Point(351, 17);
			...
			// txtProductId
			// 
			txtProductId.Location = new Point(353, 56);
			...
			label3.Location = new Point(272, 61);
			label3.Name = "label3";
			...
			// txtProviderDate
			// 
			txtProviderDate.Location = new Point(643, 17);
			...
			// btnLoad
			// 
			btnLoad.Location = new Point(732, 56);
			...
			// txtSearch
			// 
			txtSearch.Location = new Point(110, 99);
			...
			// btnSearch
			// 
			btnSearch.Location = new Point(39, 97);
			...
			// txtProviderID
			// 
			txtProviderID.Location = new Point(119, 17);
			...
			// btnDelete
			// 
			btnDelete.Location = new Point(668, 56);
			...
			// btnAdd
			// 
			btnAdd.Location = new Point(636, 56);
			...
			dataGridView.Location = new Point(42, 137);
