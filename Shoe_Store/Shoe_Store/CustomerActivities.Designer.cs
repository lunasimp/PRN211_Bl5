namespace Shoe_Store
{
	partial class CustomerActivities
	{
		...
		private void InitializeComponent()
		{
			...
			// btnUpdate
			// 
			btnUpdate.Location = new Point(708, 56);
			...
			// txtQuantity
			// 
			txtQuantity.Location = new Point(127, 57);
			...
			// txtCustomerName
			// 
			txtCustomerName.Location = new Point(359, 17);
			...
			label4.Location = new Point(240, 20);
			label4.Name = "label4";
			...
			// txtProductId
			// 
			txtProductId.Location = new Point(361, 56);
			...
			label3.Location = new Point(282, 64);
			label3.Name = "label3";
			...
			// txtPurchaseDate
			// 
			txtPurchaseDate.Location = new Point(651, 17);
			...
			// btnLoad
			// 
			btnLoad.Location = new Point(740, 56);
			...
			// txtSearch
			// 
			txtSearch.Location = new Point(118, 99);
			...
			// btnSearch
			// 
			btnSearch.Location = new Point(47, 97);
			...
			// txtCustomerID
			// 
			txtCustomerID.Location = new Point(127, 17);
			...
			// btnDelete
			// 
			btnDelete.Location = new Point(676, 56);
			...
			// btnAdd
			// 
			btnAdd.Location = new Point(644, 56);
